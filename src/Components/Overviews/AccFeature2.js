              ...
              <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                ...
                <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                  <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                    ...
                    <span className="block text-white mt-10">
                      Be calm; we are here to assist you.
                    </span>
                  </h1>
                  <p className="mt-6 max-w-lg mx-auto text-center text-xl text-gray-200 sm:max-w-3xl">
                    You are finally off to a great new adventure,
                    congratulations! We know it seems a little daunting but
                    trust us, the best is yet to come. And we are here to
                    support you all the way. To help you prepare for life in
                    your new country, we help you to chose the best
