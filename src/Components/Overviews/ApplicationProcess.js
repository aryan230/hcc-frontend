...
import Logo from "../../assets/ua2.gif";
...
const policies = [
  {
    name: "100% Refund Policy Applied",
...
const license = {
  href: "#",
  summary:
    "For personal and professional use. You cannot use the content of this site or the course enrolled for your personal use. All rights reserved by The HCC",
  content: `
    <h4>Overview</h4>
...
const ApplicationProcess = () => {
  ...
  const enrollBtnClicked = () => {
    navigate("/checkout/BFhL1tSbFJaVp0oL4yNEEWT4emy2");
  };
  return (
            ...
            <section aria-labelledby="policies-heading" className="mt-10">
              ...
              <dl className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                {policies.map((policy) => (
                  <div
                    key={policy.name}
                    className="bg-white-50 border border-green-600 rounded-lg p-6 text-center"
                  >
                    <dt>
                      <policy.icon
                        className="mx-auto h-8 w-8 flex-shrink-0 text-green-500 mb-4"
                        aria-hidden="true"
                      />
                      <span className="mt-4 text-sm font-semibold text-gray-600 uppercase">
                        {policy.name}
                      </span>
                    </dt>
                  </div>
